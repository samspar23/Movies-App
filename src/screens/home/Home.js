                        ...
                        <Card>
                            <CardContent>
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    <Select multiple input={<Input id="select-multiple-checkbox"></Input>} renderValue={selected => selected.join(',')} value={this.state.genres} onChange={this.genreSelectHandler}>
